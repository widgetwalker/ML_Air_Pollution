...
plt.tight_layout()
plt.savefig('multi_target_evaluation_lr.png', dpi=300, bbox_inches='tight')
print("  - Saved: multi_target_evaluation_lr.png")
...
plt.tight_layout()
plt.savefig('model_comparison_lr.png', dpi=300, bbox_inches='tight')
print("  - Saved: model_comparison_lr.png")
...
print(f"  - multi_target_evaluation_lr.png")
print(f"  - model_comparison_lr.png")
print("="*80)
